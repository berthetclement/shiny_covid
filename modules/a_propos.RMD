...
2. Depuis le **12/08/2021**, les données concernant la France via [opencovid19-fr](https://github.com/opencovid19-fr/data) ne sont plus mises à jour sur l'ensemble des indicateurs, [github issue](https://github.com/opencovid19-fr/data/issues/578). 
    + En attendant que les données soient mises à jour, l'application n'affichera que les données disponibles.
